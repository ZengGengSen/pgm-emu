...
******************************************************************************/
	...
	{
		//maddrone
		JumpTable=(void**)malloc(0x10000*sizeof(void*) + sizeof(void*));

		if(JumpTable==NULL) return 0;

		uintptr_t tmp = (uintptr_t)JumpTable;

		if ((tmp % sizeof(void*)) != 0)
		{
			JumpTable = (void **)(tmp + (sizeof(void*) - (tmp % sizeof(void*))));
		}
